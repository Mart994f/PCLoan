...
namespace PCLoan.Logic.Library.Controllers
{
    public class ComputerController : IComputerController
    {
        ...
        public ComputerController(ILoanRepository loanRepository, IMapper mapper, IComputerRepository computerRepository, ILoggingService loggingService)
        {
        ...
        public void RegisterLoan(int userId, LoanModelDTO model)
        {
            ...
            else
            {
                ...
                // Log it
                _loggingService.Log(userId, Actions.Loan, model.ComputerId);
            }
        }
        ...
        public void RegisterLoanReturned(int userId)
        {
            ...
            // Log it
            _loggingService.Log(userId, Actions.Return, model.ComputerId);
        }
        ...
        public LoanModelDTO GetUsersCurrentLoan(int userID)
        {
            ...
            {
                throw new UserHaveNoLoanException("Du har ikke nogle aktive lån.");
            }
